...
--
Command: Casually ask ${name} to go to the gym with me
...
--
Command: Sadly tell ${name} that I won't be able to make it to the event.
...
--
Command: Angrily ask ${name} to pay me back.
...
--
Command: Tiredly tell ${name} that I don't want to go to the event.
...
--
Command: Seriously tell ${name} that I need to talk to them.
