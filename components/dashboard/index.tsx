...
const Dashboard: React.FC<Props> = ({ auth, signOut, user }) => {
  ...
  return (
    <>
      ...
      <New />
      <main className="p-4">
        <h1 className="w-full text-center mb-6 text-lg font-bold text-slate-700">Your Circles</h1>
          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="px-4 pt-4 pb-2">
                <p className="text-sm text-slate-500">If you're unhappy with your purchase for any reason, email us within 90 days and we'll refund you in full, no questions asked.</p>
